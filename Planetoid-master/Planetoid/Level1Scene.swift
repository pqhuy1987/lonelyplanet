...
class Level1Scene: SKScene, SKPhysicsContactDelegate {
    ...
    func moveAsteroidsForUpdate() {
        ...
        self.enumerateChildNodes(withName: kAsteroidName) { node, stop in
            ...
            let rotateAsteroid = SKAction.rotate(byAngle: CGFloat(M_PI_4)/32, duration: 0)
...
//        }
    ...
    func setupStars(_ starCount : Int) {
        ...
        for i in 0...starCount {
            ...
            let starPositionY = CGFloat.random(min: self.frame.minY, max: self.frame.maxY)
    ...
    func setupAsteroids(_ asteroidCount : Int) {
        ...
        for i in 0...asteroidCount {
            ...
            let asteroidPositionY = Bool.random()
                ? CGFloat.random(min: self.frame.minY, max: self.frame.maxY*clearPath.top) //position UP
                : CGFloat.random(min: self.frame.maxY*clearPath.bottom, max: self.frame.maxY) //position DOWN
    ...
    func playSoundFromArray(_ soundArray : [String]) {
